...
# -StartWhenAvailable: 08:40에 PC가 꺼져 있었으면 부팅 후 즉시 실행
...
Write-Host "Done: $taskName registered. Runs daily at 08:40 KST (or on next boot if missed)." -ForegroundColor Green
